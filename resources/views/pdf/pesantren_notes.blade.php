...
<body>
    ...
    <div class="stats-row">
        ...
        <div class="stat-box" style="background:#1a6b3c;">
            ...
            <div class="stat-value">{{ $stats['praise'] }}</div>
        </div>
        ...
        <div class="stat-box" style="background:#e6a817;">
            ...
            <div class="stat-value">{{ $stats['absence'] }}</div>
        </div>
            ...
            @forelse($notes as $i => $note)
                <tr>
                    ...
                    <td style="max-width:90px; word-wrap:break-word; font-size:9px; color:#555;">
                        @if ($note->target_achievement)
                            <b>Target:</b> {{ Str::limit($note->target_achievement, 50) }}<br>
                        @endif
                        @if ($note->reason)
                            <b>Alasan:</b> {{ Str::limit($note->reason, 50) }}
                        @endif
                    </td>
