...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .type-company  { background:#d4edda; color:#155724; }
        .type-national { background:#cce5ff; color:#004085; }
        .badge { display:inline-block; padding:2px 8px; border-radius:10px; font-size:8.5px; font-weight:600; }
        .active-today { color:#1a6b3c; font-weight:700; }
...
<table>
    ...
    <tbody>
        ...
        @empty
            <tr><td colspan="8" style="text-align:center; color:#aaa; font-style:italic; padding:16px;">Tidak ada data hari libur.</td></tr>
        @endforelse
    </tbody>
</table>
