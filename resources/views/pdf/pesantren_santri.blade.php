...
<body>
    <div class="header">
        ...
        <div>
            ...
            <div class="sub">Total:
                {{ is_object($santriList) && method_exists($santriList, 'total') ? $santriList->total() : count($santriList) }}
                santri</div>
        </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" style="text-align:center; color:#aaa; font-style:italic; padding:16px;">Tidak ada
                        data santri.</td>
                </tr>
            @endforelse
        </tbody>
