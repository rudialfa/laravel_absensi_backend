...
<body>
    ...
    <div class="stats-row">
        ...
        <div class="stat-box">
            ...
            <div class="stat-value" style="color:#1a6b3c;">{{ $stats['max_score'] }}</div>
        </div>
        <div class="stat-box">
            <div class="stat-label">Terendah</div>
            <div class="stat-value" style="color:#c0392b;">{{ $stats['min_score'] }}</div>
        </div>
        <div class="stat-box">
            <div class="stat-label">Skor ≥ 80</div>
            <div class="stat-value" style="color:#1a6b3c;">{{ $stats['above_80'] }}</div>
        </div>
        <div class="stat-box">
            <div class="stat-label">Skor &lt; 50</div>
            <div class="stat-value" style="color:#c0392b;">{{ $stats['below_50'] }}</div>
        </div>
    </div>
