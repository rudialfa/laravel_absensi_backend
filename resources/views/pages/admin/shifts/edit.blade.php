                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="company_id" class="form-control" required>
                                    @foreach ($companies as $c)
                                        <option value="{{ $c->id }}"
                                            {{ $shift->company_id == $c->id ? 'selected' : '' }}>
                                            {{ $c->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" name="start_time" class="form-control"
                                    value="{{ \Carbon\Carbon::parse($shift->start_time)->format('H:i') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" name="end_time" class="form-control"
                                    value="{{ \Carbon\Carbon::parse($shift->end_time)->format('H:i') }}" required>
                            </div>
